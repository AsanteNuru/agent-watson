...
import sys
import os
from Watson import watson_agent, WatsonDeps, store_message, fetch_conversation_history, model
...
@app.post("/api/watson_api_endpoint", response_model=AgentResponse)
async def github_agent_endpoint(
    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            ...
            # Run the agent with conversation history and timeout
            try:
        ...
        return AgentResponse(success=True, response=result.data)
        ...
        return AgentResponse(success=False, response="I apologize, but I encountered an error processing your request.")
